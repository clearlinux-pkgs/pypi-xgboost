...
Source0  : https://files.pythonhosted.org/packages/c1/57/3d73029d72be166b3334121560bc72ea7d96dd2c6839a3bcad6be2cd6774/xgboost-2.1.0.tar.gz
...
%prep
%setup -q -n xgboost-2.1.0
cd %{_builddir}/xgboost-2.1.0
pushd ..
cp -a xgboost-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718921769
