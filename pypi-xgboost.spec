...
Source0  : https://files.pythonhosted.org/packages/d2/d5/8d93a950a379b34767ac118cf5653977048e291c6695713a60863532ec08/xgboost-2.1.2.tar.gz
...
%prep
%setup -q -n xgboost-2.1.2
cd %{_builddir}/xgboost-2.1.2
pushd ..
cp -a xgboost-2.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729723113
