...
Source0  : https://files.pythonhosted.org/packages/48/b0/131ffc4a15fd3acee9be3a7baa6b2fa6faa479799c51b880de9fc3ddf550/xgboost-2.1.3.tar.gz
...
%prep
%setup -q -n xgboost-2.1.3
cd %{_builddir}/xgboost-2.1.3
pushd ..
cp -a xgboost-2.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732635140
