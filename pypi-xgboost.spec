...
Source0  : https://files.pythonhosted.org/packages/e2/5e/860a1ef13ce38db8c257c83e138be64bcffde8f401e84bf1e2e91838afa3/xgboost-2.1.4.tar.gz
...
%prep
%setup -q -n xgboost-2.1.4
cd %{_builddir}/xgboost-2.1.4
pushd ..
cp -a xgboost-2.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738881560
